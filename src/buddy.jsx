...
import { Mic, MicOff, Volume2, VolumeX, MapPin, Clock, Bus, Navigation, Languages, User } from 'lucide-react';
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex-1">
                    <h3 id={`route-${index}`} className="text-2xl font-bold text-gray-800 mb-2">
                  ...
                  <div className="mt-4 md:mt-0">
                    <button
                      onClick={() => speak(`Bus ${route.number} goes from ${route.from} to ${route.to} via ${route.via}. Journey time is ${route.duration} and buses run every ${route.frequency} minutes.`)}
